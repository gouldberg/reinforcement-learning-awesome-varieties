...
# You can check the einvironment
...
class D4PGCritic(nn.Module):
    ...
    def distr_to_q(self, distr):
        ...
        # self.supports come from self.register_buffer("supports", ...)
...
##############################################################################################
# --------------------------------------------------------------------------------------------
# Ant Agent Learning:  Distributed Distributional Deep Deterministic Policy Gradients (D4PG)
# --------------------------------------------------------------------------------------------
...
# ----------
# !!! increase _max_episode_tesps from 1000 to 1000*3 !!!
# env._max_episode_steps = 1000*3
# test_env._max_episode_steps = 1000*3
...
args_name = 'trial'
writer = SummaryWriter(comment="-ant_d4pg_" + args_name)

save_path = os.path.join(base_path, '04_output/02_deep_reinforcement_learning_hands_on/ant/d4pg_trial/model')
...
# ----------
# Monitor wrapper
model_path = os.path.join(base_path, '04_output/02_deep_reinforcement_learning_hands_on/ant/d4pg_trial/model/best_+756.373_51000.dat')
record_dir = os.path.join(base_path, '04_output/02_deep_reinforcement_learning_hands_on/ant/d4pg_trial/video')
...
xvfb-run -s "-screen 0 640x480x24 +extension GLX" \
    ./ant_pybullet_02_D4PG_play.py \
        -m /home/kswada/kw/reinforcement_learning/04_output/02_deep_reinforcement_learning_hands_on/ant/d4pg_trial_202301030825/model/final_628192.dat \
            -r /home/kswada/kw/reinforcement_learning/04_output/02_deep_reinforcement_learning_hands_on/ant/d4pg_trial_202301030825/video/final_628192

xvfb-run -s "-screen 0 640x480x24 +extension GLX" \
    ./ant_pybullet_02_D4PG_play.py \
        -m /home/kswada/kw/reinforcement_learning/04_output/02_deep_reinforcement_learning_hands_on/ant/d4pg_trial_202301030825/model/best_+695.317_289000.dat \
            -r /home/kswada/kw/reinforcement_learning/04_output/02_deep_reinforcement_learning_hands_on/ant/d4pg_trial_202301030825/video/best_+695.317_289000
