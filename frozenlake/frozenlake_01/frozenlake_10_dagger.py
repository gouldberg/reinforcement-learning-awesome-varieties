...
#############################################################################################################
# -----------------------------------------------------------------------------------------------------------
# Imitation learning from Teacher
# -----------------------------------------------------------------------------------------------------------

base_path = '/home/kswada/kw/reinforcement_learning'

model_dir = os.path.join(base_path, '04_output/01_reinforcement_learning_by_python/frozenlake/model')
file_name = "imitation_teacher.pkl"
...
agent = TeacherAgent.train(
    env = env,
    episode_count = episode_count,
    gamma = gamma,
    initial_epsilon = initial_epsilon,
    final_epsilon = final_epsilon,
    report_interval = report_inverval
    )
...
# ----------
teacher_agent = TeacherAgent.load(env, model_path)
