...
##############################################################################################
# --------------------------------------------------------------------------------------------
# HalfCheetah Agent Learning:  Distributed Distributional Deep Deterministic Policy Gradients (D4PG)
# --------------------------------------------------------------------------------------------
...
args_name = 'trial'
writer = SummaryWriter(comment="-halfcheetah_d4pg_" + args_name)
...
# ----------
# Monitor wrapper
model_path = os.path.join(base_path, '04_output/02_deep_reinforcement_learning_hands_on/halfcheetah/d4pg_trial/model/best_+756.373_51000.dat')
record_dir = os.path.join(base_path, '04_output/02_deep_reinforcement_learning_hands_on/halfcheetah/d4pg_trial/video')
...
xvfb-run -s "-screen 0 640x480x24 +extension GLX" \
    ./halfcheetah_pybullet_02_D4PG_play.py \
        -m /home/kswada/kw/reinforcement_learning/04_output/02_deep_reinforcement_learning_hands_on/halfcheetah/d4pg_trial_202301031256/model/final_1189746.dat \
            -r /home/kswada/kw/reinforcement_learning/04_output/02_deep_reinforcement_learning_hands_on/halfcheetah/d4pg_trial_202301031256/video/final_1189746

xvfb-run -s "-screen 0 640x480x24 +extension GLX" \
    ./halfcheetah_pybullet_02_D4PG_play.py \
        -m /home/kswada/kw/reinforcement_learning/04_output/02_deep_reinforcement_learning_hands_on/halfcheetah/d4pg_trial_202301031256/model/best_+2302.844_1141000.dat \
            -r /home/kswada/kw/reinforcement_learning/04_output/02_deep_reinforcement_learning_hands_on/halfcheetah/d4pg_trial_202301031256/video/best_+2302.844_1141000
