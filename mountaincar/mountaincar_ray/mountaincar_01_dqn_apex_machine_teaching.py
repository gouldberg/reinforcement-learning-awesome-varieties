...
# STRATEGY = "default"
STRATEGY = "with_dueling"
# STRATEGY = "demonstration"
# STRATEGY = "demonstration"


# For each strategy strategy, we will kick off 5 different training sessions
# of 2 million (= MAX_STEPS) time steps each.
# At the end of each training session, 
# We will evaluate the trained agent over NUM_FINAL_EVAL_EPS = 20 episodes,
# where lower number indicates better performance.
...
# ----------
base_path = '/home/kswada/kw/rl_rllib'
path_csvoutput = os.path.join(base_path, f'04_output/mountaincar/dqn_apex_machine_teaching/{STRATEGY}_results.csv')
...
for i in range(NUM_TRIALS):
    ...
    # ----------
    with open(os.path.join(path_csvoutput), "a") as f:
        writer = csv.writer(f)
