...
NAME = "02_nsteps"
setup_ignite(engine, params, exp_source, f"{NAME}={n}")
...
model_path = os.path.join(base_path, '04_output/pong/deep_q_learning_ptan/model/PongNoFrameskip-v4-02_nsteps.pth')
