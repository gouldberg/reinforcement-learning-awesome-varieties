...
NAME = "03_double"
setup_ignite(engine, params, exp_source, f"{NAME}={args_double}", extra_metrics=('values',))
...
model_path = os.path.join(base_path, '04_output/pong/deep_q_learning_ptan/model/PongNoFrameskip-v4-03_double.pth')
